init python:
  class Quest_where_to_sell_bots(Quest):
    quest_type="note"

    name="Where to sell bots"
    ...
    class phase_1_notes:
      def description(self):
        ...
        if rv:
          ...
          rv="{info}You don't know where to sell bots. You need to ask around, check markets, and maybe other places.{/}"
        return rv
